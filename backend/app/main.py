...
app = FastAPI(title="SportsCard Vault API", version="0.22.4.6", description="Detailed sports-card collection API with editable scan review, correction learning data, transparent comp-based valuation, and an offline-first test UI.")
...
@app.get("/health")
def health(): return {"status":"ok","version":"0.22.4.6","environment":settings.app_env,"recognition":settings.recognition_provider,"pricing_provider":settings.price_provider,"database_provider":settings.database_provider}
